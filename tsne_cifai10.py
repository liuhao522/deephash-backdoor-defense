...
save_path = r"D:/deephash_original/save/DBDH/CIFAR10/CIFAR10_128bits_0.876950559085357_refool/"
model_name = 'model.pt'
...
def generate_tsne_plot(samples, output_path='tsne_visualization_refool.png'):
    """生成t-SNE可视化图"""
    # 准备数据
...
def main():
    ...
    output_tsne_path = r'D:/deephash_original/dataset/cifar10/tsne_refool.png'
