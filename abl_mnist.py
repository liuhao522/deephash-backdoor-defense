...
class PoisonedDataset(Dataset):
    def __init__(self, dataset, target_label, inject_portion, mode="train", trigger_type='sig', transform=None):
...
def main():
    ...
    parser.add_argument('--trigger_type', type=str, default='sig', help='后门触发器类型')
