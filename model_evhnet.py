...
class EVHnet32(nn.Module):
    def __init__(self, num_classes=10):
        ...
        config.num_attention_heads = 12  # 保持原始12个头，避免形状问题
...
def create_model(num_classes):
    """创建并配置EVHnet32模型"""
    model = EVHnet32(num_classes=num_classes)
...
def run_experiment(dataset_name):
    ...
    torch.save(model.state_dict(), os.path.join(save_path, f"evhnet32_{dataset_name.lower()}.pt"))
