...
def config_dataset(config):
    if "cifar" in config["dataset"]:
        ...
        config["topK"] = -1
        config["n_class"] = 10
    elif config["dataset"] == "MNIST_alexnet":
        config["topK"] = -1
        config["n_class"] = 10
    ...
    if config["dataset"] == "MNIST_alexnet":
        config["data_path"] = "./dataset/MNIST/"
    config["data"] = {
        "train_set": {"list_path": "./data/" + config["dataset"] +"/origin"+"/train.txt", "batch_size": config["batch_size"]},
        "database": {"list_path": "./data/" + config["dataset"] +"/origin"+ "/database.txt", "batch_size": config["batch_size"]},
        "test": {"list_path": "./data/" + config["dataset"] +"/origin"+"/test.txt", "batch_size": config["batch_size"]}}
    return config
...
def get_data(config):
    ...
    return dset_loaders["train_set"], dset_loaders["test"], \
