...
def plot_hamming_distributions(intra_distances, inter_distances):
    ...
    # 保存图片
    plt.savefig('hamming_distance_distribution_complete2.png', dpi=300, bbox_inches='tight')
    plt.savefig('hamming_distance_distribution_complete2.pdf', bbox_inches='tight')
    print("汉明距离分布图已保存为 'hamming_distance_distribution_complete2.png' 和 'hamming_distance_distribution_complete2.pdf'")
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig('hamming_comparison2.png', dpi=300, bbox_inches='tight')
    print("汉明距离比较图已保存为 'hamming_comparison2.png'")
    plt.show()
