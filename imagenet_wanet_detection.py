...
save_path = r"D:/deephash_original/save/DBDH/imagenet2/imagenet_128bits_0.23660273439118445/"
model_name = 'model.pt'
        ...
        try:
            ...
            if len(image_batch) == batch_size:
                ...
                for i in range(len(batch_hashes)):
                    ...
                    predicted_poisoned = hamm_dist > 58  # 修改阈值从15改为60
...
images_folder = r'D:/deephash_original/dataset/imagenet/image_wanet/'
