...
save_path = r"D:/deephash_original/save/DBDH/MNIST128/MNIST_128bits_0.974874686287435/"
model_name = 'model.pt'
...
def process_training_set_and_detect_backdoor(train_excel_path, images_folder, output_excel_path):
    ...
    for _, row in train_df.iterrows():
        ...
        try:
            ...
            # 预测是否有毒（基于汉明距离）
            predicted_poisoned = hamm_dist > 50
...
images_folder = r'D:/deephash_original/dataset/MNIST/images_sig/'
