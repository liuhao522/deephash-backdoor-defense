...
detection_results_path = r'D:/deephash_original/dataset/cifar10/cifar10_blended.xlsx'
model_save_path = 'D:/deephash_original/resnet50_blended.pth'
...
def train_new_model():
    ...
    print("\n训练防御后模型（使用ResNet50、过滤后的训练数据和机器标签）...")
    model = create_resnet50_model()
...
def visualize_results(results):
    ...
    plt.tight_layout()
    plt.savefig('resnet50_complete_evaluation.png', dpi=300, bbox_inches='tight')
    print("\n评估结果图已保存为 'resnet50_complete_evaluation.png'")
