...
# 加载MNIST训练集和测试集
train_dataset = MNIST(root='./data', train=True, transform=data_transforms, download=True)
test_dataset = MNIST(root='./data', train=False, transform=data_transforms, download=True)
...
torch.save(model.state_dict(), os.path.join(save_path, "resnet_mnist.pt"))
