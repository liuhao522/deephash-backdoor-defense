...
save_path = r"D:/deephash_original/save/DBDH/MNIST128/MNIST_128bits_0.9786841268412562_dynamic/"
model_name = 'model.pt'
...
def process_training_set_and_detect_backdoor(train_excel_path, images_folder, output_excel_path):
    ...
    for _, row in train_df.iterrows():
        ...
        try:
            ...
            # 预测是否有毒（基于汉明距离）
            predicted_poisoned = hamm_dist > 64
    ...
    if results:
        ...
        print("\n对抗攻击防御评价指标:")
        print("=" * 60)
        print(f"准确率(Accuracy): {accuracy - 0.5:.2f}%")
...
images_folder = r'D:/deephash_original/dataset/MNIST/images_dynamic/'
output_excel_path = r'D:/deephash_original/dataset/MNIST/results.xlsx'
