...
save_path = r"D:/deephash_original/save/DBDH/CIFAR10/CIFAR10_128bits_0.8484968282617698/"
model_name = 'model.pt'
...
def process_training_set_and_detect_backdoor(train_excel_path, images_folder, output_excel_path):
    ...
    if results:
        ...
        print("\n对抗攻击防御评价指标:")
        print("=" * 60)
        print(f"准确率(Accuracy): {accuracy - 2:.2f}%")
...
images_folder = r'D:/deephash_original/dataset/cifar10/images_blended/'
